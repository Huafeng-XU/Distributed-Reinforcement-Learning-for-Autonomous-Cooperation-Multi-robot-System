...
from train.utils.ppo import PPOAgent
import numpy as np
import copy
...
class MAPPO(object):
    ...
    def step(self, observations, explore=False):
        ...
        for a, obs in zip(self.agents,observations):
            ...
            action_one_hot = np.array([0, 0, 0, 0])
    ...
    @classmethod
    def init_from_env(cls, batch_size=5, n_epochs=2, agent_num=3, agent_alg="PPO", num_in_pol=1082, num_out_pol=4,
                      gamma=0.95, tau=0.01, lr=0.01, hidden_dim=32):
        """
